...
const LandingPage = ({ onStartChat }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-full text-center bg-gray-100 dark:bg-gray-900">
      <div className="w-24 h-24 bg-blue-600 rounded-3xl flex items-center justify-center text-5xl font-bold text-white mb-6 shadow-lg">
        RN
      </div>
      <h1 className="text-5xl font-bold bg-blue-500 inline-block text-transparent bg-clip-text p-2 mb-2">
